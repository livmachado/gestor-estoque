...
export default function ModalTransaction({ isOpen, onClose }: modalType) {
    const [isOut, setIsOut] = useState("out")
  if (isOpen) {
    return (
        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <div className="w-1/2">
              ...
              /> */}
              <button
                onClick={() => setIsOut(isOut? "OUT" : "IN")}
                className={`flex items-center px-4 py-2 rounded-full font-medium text-white shadow-md transition duration-300 ${
                  isOut
